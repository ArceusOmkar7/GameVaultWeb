...
/**
 * Handles image uploads for games in the admin area.
 * Performs validation, saves files, and updates game records.
 */
@WebServlet(name = "GameImageUploadServlet", urlPatterns = { "/admin/upload-image" })
...
public class GameImageUploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (gameManagement == null) {
            ServletUtil.setErrorMessage(request, "System error: Game management service not available.");
            ServletUtil.forwardToJsp(request, response, "/WEB-INF/jsp/error.jsp");
            return;
        }

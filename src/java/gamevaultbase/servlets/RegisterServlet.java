...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String password = request.getParameter("password"); // Plain text - INSECURE
        ...
        try {
            ...
            // --- Create User Object ---
            // WARNING: Storing plain text password directly - Highly Insecure!
            User newUser = new User(email, password, username, balance);
            newUser.setCreatedAt(new Date()); // Set the registration timestamp

...
<html lang="en">
  <head>
    <c:set var="pageTitle" value="Admin Dummy Data Generator" />
  ...
  <body class="bg-gray-100">
    ...
    >
      ...
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Dummy Data Generator</h1>
      </div>
...
${stackTrace}</pre
              ...
              <c:if test="${generationSuccess}">
                ...
                >
                  <p class="font-medium">Successfully generated dummy data!</p>
                </div>
              </c:if>

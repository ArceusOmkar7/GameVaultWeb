        ...
        <c:when test="${not empty cartGames}">
          <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <ul role="list" class="divide-y divide-gray-200">
              <c:forEach var="game" items="${cartGames}">
                <li class="p-4 sm:p-6 flex items-center">
                  ...
                  <div
                    class="flex-shrink-0 w-24 h-24 bg-gray-200 rounded-md flex items-center justify-center text-gray-400 mr-4"
                  >
                    <svg
                  ...
                  <div class="flex-1 flex justify-between items-start">
                    <div>
                      ...
                      <h3 class="text-lg font-medium text-gray-900">
                        <a
                          href="${pageContext.request.contextPath}/game?id=${game.gameId}"
                    ...
                    <div class="text-right ml-4 flex flex-col items-end">
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          class="text-sm font-medium text-red-600 hover:text-red-500 transition duration-150 ease-in-out"
                        >
                          Remove
                        </button>
                      </form>
            ...
            <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
              <div
                class="flex justify-between text-lg font-medium text-gray-900 mb-4"
              >
                <p>Subtotal</p>
              ...
              <p class="mb-4 text-sm text-gray-500">
                Shipping and taxes calculated at checkout (if applicable).
              </p>
              ...
              >
                ...
                >
                  Purchase for myself (<fmt:formatNumber
                    value="${cartTotal}"
                    type="currency"
                    currencySymbol="$"
                  />)

            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mt-1 text-lg text-gray-900"><c:out value="${user.username}" /></p>
                    </div>

                    <div>
                        <p class="text-sm font-medium text-gray-500">Email</p>
                        <p class="mt-1 text-lg text-gray-900"><c:out value="${user.email}" /></p>
                    </div>
                    ...
                    <div class="pt-4 border-t">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-bold text-gray-900">
                                    $<fmt:formatNumber value="${user.walletBalance}" pattern="#,##0.00" />
                                </p>
                            </div>
                            <button onclick="document.getElementById('addBalanceForm').classList.toggle('hidden')"
                        ...
                        <form id="addBalanceForm" action="${pageContext.request.contextPath}/addBalance" 
                              method="post" class="hidden mt-4 p-4 bg-gray-50 rounded">

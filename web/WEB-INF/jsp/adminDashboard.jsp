    ...
    >
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <span class="sidebar-label text-2xl font-bold text-gray-200"
            >GameVault</span
          >
        </div>
        ...
        <button
          id="toggleSidebar"
          class="hidden md:inline text-2xl focus:outline-none text-gray-200 ml-2"
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a
              ...
              <span class="sidebar-label text-gray-200"
    ...
    <script>
      ...
      function setActive(btnId) {
        ["dayBtn", "weekBtn", "monthBtn"].forEach((id) => {
          document
            .getElementById(id)
            .classList.remove("bg-gray-300", "font-bold");
        });
        document
